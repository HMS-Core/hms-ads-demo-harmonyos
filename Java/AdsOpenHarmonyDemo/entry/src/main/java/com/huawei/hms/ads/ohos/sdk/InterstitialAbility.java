...
public class InterstitialAbility extends BaseAbility {

    private static final HiLogLabel LABEL = new HiLogLabel(HiLog.LOG_APP, 0X10201, InterstitialAbility.class.getSimpleName());
    ...
    public void onStart(Intent intent) {
        ...
        super.setUIContent(ResourceTable.Layout_ability_interstitial);
