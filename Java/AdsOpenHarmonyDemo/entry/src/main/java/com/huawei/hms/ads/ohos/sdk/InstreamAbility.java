...
public class InstreamAbility extends BaseAbility implements MediaMuteListener {
    private static final HiLogLabel LABEL = new HiLogLabel(HiLog.LOG_APP, 0X00201, InstreamAbility.class.getSimpleName());
    ...
    public void onStart(Intent intent) {
        ...
        setUIContent(ResourceTable.Layout_ability_instream);
